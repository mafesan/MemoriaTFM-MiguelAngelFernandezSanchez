...
To the people who have helped me to review and improve this thesis: Gregorio, Santi, Valerio, Fernando, Saray, Eva and Sara. Thank you
...
With the identification of such artefacts, the knowledge of usage and evolution of UML models can be widened,
...
(FLOSS) alojados en \emph{GitHub}, una plataforma dedicada al desarrollo de software que a día de hoy cuenta con millones de proyectos software. En el pasado se habían realizado varios estudios
...
about how software is being developed: productivity, issue-tracking methods, developer-to-developer relations, etc. [RGBM06]
...
Given the large size of GitHub as a platform and its access limitations, this research required to build a tool which extracts
...
The way people develop software has evolved during the last years. There is an extended social perception of developers to
...
database with most of the information which the GitHub API can provide.
...
\textbf{GHTorrent} is a project aimed to create a scalable, queriable, off-line mirror of data offered through the GitHub \textit{API}.
...
The papers are available in Appendix~\ref{app:papers}.
...
UML: Mining GitHub'' [HQC + 16 - cite] (The full paper is available in Appendix~\ref{sec:paper-models}).
...
129,276 original ones.
 ...
 \begin{figure}
   ...
   \caption{Diagram: Distribution from potential files with UML to validated UML files. \textcolor{red}{FIXME: Change .-notation to ,-notation in the Figure!}}
...
\label{sec:paper-msr}
This paper was published in the MSR conference (Buenos Aires, Argentina), in May 2017.
...
This paper was published in the ICSE (SEIP track) conference (Buenos Aires, Argentina), in May 2017.
