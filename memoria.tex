...
\begin{itemize}
  ...
  \item \texttt{FILECOMMITS}: \textcolor{red}{FIXME}
...
\begin{enumerate}
  \item ``Informática I'' (Fundamentals of Programming): This course was my first programming-related course,
  where I learned the basics of programming'' (basic data and flow-control structures).
  \item ``Informática II'' (Telecommunication Systems programming): In this course I learned advance programming
  ...
  \item ``Arquitectura de Internet'' and ``Sistemas Telemáticos para medios audiovisuales'' (Computer networks):
  ...
  \item ``Protocolos de Transmisión de Audio y Video en Internet'' (Audio/video transmission protocols):
  ...
  \item ``Laboratorio de Tecnologías Audiovisuales en la Web'' (Web-based technologies): Though this course is not directly
  related, I learned basic concepts about databases and I improved my programming skils in Python.
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
