...
Python, C++, etc.), but GitHub does not offer a mechanism through which you can identify projects
...
\begin{itemize}
  \item RQ1: How many GitHub repositories contains at least one file with a certain extension or a certain
...
For analyse the data from all GitHub in a proper way, we needed an static, reliable and updated source of this platform.\
This source is produced by the GHTorrent project by a queriable, offline database with most of the information which GitHub REST API can provide.\\
