...
account, which caused a huge impact in the research and the data-retrieval process, as it is detailed in the case of study described in
section~\ref{sec:case-study-uml}.\\\\
...
\begin{table}[]
  \centering
  \caption{Validated positive repositories sorted by their number of UML models.}
...
\textcolor{red}{FIXME: Add more examples about the obtained results and complete it with the full search in the whole set of projects.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CONCLUSIONES %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
This paper was published in MODELS conference, in July, 2016.
