...
is probably the best way to know deeply how its software is evolving over time, so they can use this data to make the right decissions
for the future (known as data-driven decissions).\\\\
...
To complete the context for this dissertation is necessary to situate what UML is and why it is imporant.
The Universal Modeling Langage (UML) is a graphic, descriptive language to visualize, specify, construct and document the
...
the identified models constitute a dataset that is two orders of magnitude larger than the rest of UML datasets at the time of this research.\\\\
\begin{table}[]
  \centering
  ...
  \end{tabular}
\end{table}
Applying the data-analysis phase to the complete UML models dataset we ended up with a database with deeper information about these results,
which broaden the posibilities to enrich different aspects of this research. This derived in the paper "Practices and Perceptions of UML Use
...
\begin{enumerate}
  \item \textbf{Filtering short-time projects out}: For this paper, reserachers aimed
