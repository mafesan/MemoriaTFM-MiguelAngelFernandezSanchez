...
Cristina, Nuria, Raquel and many more. Without your friendship, help and support I would not reached this goal, thank you.
...
\begin{enumerate}
  ...
  \item Run the Python script \texttt{input\_projects.py} setting up the corresponding filters and parameters to obtain the main
...
This paper was published in the MODELS conference (Saint-Malo, France), in October 2016.  The complete references is following:
...
\label{sec:paper-msr}
This paper was published in the MSR conference (Buenos Aires, Argentina), in May 2017. The complete references is following:
