...
\begin{itemize}
  ...
  \item \textbf{url}: Link to this object in \emph{GitHub} \textit{API}.
\end{itemize}
...
in the \emph{GitHub} \textit{API}), to the \texttt{URL} for the actual file which that object is representing to.
