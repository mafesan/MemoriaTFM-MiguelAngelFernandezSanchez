...
FIXME: not sure why you talk about this in your thesis. I would talk more about UML and what it supposes!
...
day using interactive applications which allow us to participate somehow in a social network. Because of handling these
...
and generally they are visible to everybody.
...
\begin{figure}
  ...
  \caption{Evolution of number of repositories on GitHub across time - FIXME: this graph belongs to related research}
